...
// TODO: read the question again to understand
class Solution {
  public:
    vector<int> nextGreaterElement(vector<int> &findNums, vector<int> &nums) {
        // from bottom to top: lager to smaller
        stack<int> st;
        // value, corresponding Next Greater Number
        unordered_map<int, int> val_NG;
        for (auto &&n : nums) {
